...
function cargarEscenario(){
    ...
    if(marcador1>=3 || marcador2 >= 3){
        ...
        // Mostrar el mensaje "LISTOS?" al inicio si no hay ganador
        listos();
        document.querySelector('.msj').setAttribute('onclick','conteo()');
...
function conteo(){
    ...
    document.querySelector('.msj').setAttribute('onclick',''); // Bloquear clic en el div
